...
namespace GloryofGuardian.Content.Projectiles
{
    public class PaleShotGunDT : GOGDT
    {
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            Main.EntitySpriteDraw(texture, drawPosition + new Vector2((float)Math.Cos(wrotation), (float)Math.Sin(wrotation)) * 0.4f * dirrecoil, null, lightColor, wrotation, texture.Size() * 0.5f + new Vector2(-4, -0) + fix, Projectile.scale * 1.2f, spriteEffects, 0);
