...
{
    public class ImmortalAltarProj : GOGLaserBeamProj, ILocalizedModType
    {
        ...
        public override Texture2D LaserBeginTexture => ModContent.Request<Texture2D>(GOGConstant.Projectiles + "ImmortalAltarProjBegin").Value;
        public override Texture2D LaserMiddleTexture => ModContent.Request<Texture2D>(GOGConstant.Projectiles + "ImmortalAltarProjMid").Value;
        public override Texture2D LaserEndTexture => ModContent.Request<Texture2D>(GOGConstant.Projectiles + "ImmortalAltarProjEnd").Value;
