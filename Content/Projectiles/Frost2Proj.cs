...
{
    public class Frost2Proj : GOGProj
    {
        ...
        public override void AI() {
            ...
            if (count % 1 == 0) {
                for (int i = 0; i < 4; i++) {
                    int num = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.SnowflakeIce, 0f, 0f, 10, Color.White, 0.8f);
        ...
        public override bool PreDraw(ref Color lightColor) {
            Texture2D texture = ModContent.Request<Texture2D>(GOGConstant.Projectiles + "Frost2Proj").Value;
