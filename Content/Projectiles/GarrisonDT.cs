...
namespace GloryofGuardian.Content.Projectiles
{
    public class GarrisonDT : GOGDT
    {
                    ...
                    for (int i = 0; i < 1; i++) {
                        ...
                        if (Projectile.ModProjectile is GOGDT proj0 && proj0.OrichalcumMarkDT) {
                            if (proj1.ModProjectile is GOGProj proj2) {
                                proj2.OrichalcumMarkProj = true;
                                proj2.OrichalcumMarkProjcount = 300;
                                if (Owner.GetModPlayer<GOGModPlayer>().reversehookarrow) proj2.ReverseHookArrow = true;
                            }
                        }
                    }
                }
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            Main.EntitySpriteDraw(texture, drawPosition, null, lightColor, wrotation, texture.Size() * 0.5f + new Vector2(-12, -4), Projectile.scale * 1.2f, spriteEffects, 0);
