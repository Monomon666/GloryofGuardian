...
{
    public class FinalSpiralfProj0 : GOGLaserBeamProj, ILocalizedModType
    {
        ...
        public override Texture2D LaserBeginTexture => ModContent.Request<Texture2D>(GOGConstant.Projectiles + "FinalSpiralfBegin").Value;
        public override Texture2D LaserMiddleTexture => ModContent.Request<Texture2D>(GOGConstant.Projectiles + "FinalSpiralfMid").Value;
        public override Texture2D LaserEndTexture => ModContent.Request<Texture2D>(GOGConstant.Projectiles + "FinalSpiralfEnd").Value;
