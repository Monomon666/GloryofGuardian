...
{
    public class NanoGuiderHeld : GOGProj
    {
        //有目标转移对玩家方向、手持弹幕指向的处理的典例
        public override string Texture => GOGConstant.Weapons + "NanoGuider";
        ...
        public override bool PreDraw(ref Color lightColor) {
            Texture2D texture1 = ModContent.Request<Texture2D>(GOGConstant.Weapons + "NanoGuider").Value;
            Texture2D texture2 = ModContent.Request<Texture2D>(GOGConstant.Weapons + "NanoGuiderGlow").Value;
