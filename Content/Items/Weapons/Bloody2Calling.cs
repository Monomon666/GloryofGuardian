...
{
    public class Bloody2Calling : GOGCalling
    {
        ...
        public override void SetDefaults() {
            ...
            Item.shoot = ModContent.ProjectileType<Bloody2DT>();
            Item.shootSpeed = 5f;
        ...
        public override bool CanUseItem(Player player) {
            ...
            if (player.altFunctionUse == 2) {
                ...
                for (int i = 0; i < Main.maxProjectiles; i++) {
                    ...
                    if (proj.type == ModContent.ProjectileType<Bloody2DT>() && proj.owner == player.whoAmI) {
                        proj.Kill();
                    }
                }
            }
        ...
        public override void AddRecipes() {
            ...
            recipe.AddIngredient(ModContent.ItemType<BloodyCalling>(), 1);
