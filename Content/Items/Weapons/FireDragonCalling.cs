...
{
    public class FireDragonCalling : GOGCalling
    {
        ...
        public override void SetDefaults() {
            ...
            Item.shoot = ModContent.ProjectileType<FireDragonDT>();
            Item.shootSpeed = 12f;
        ...
        public override bool CanUseItem(Player player) {
            ...
            if (player.altFunctionUse == 2) {
                ...
                for (int i = 0; i < Main.maxProjectiles; i++) {
                    ...
                    if (proj.type == ModContent.ProjectileType<FireDragonDT>() && proj.owner == player.whoAmI) {
                        proj.Kill();
                    }
                }
            }
