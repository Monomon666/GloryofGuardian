...
{
    public class Corrupt2Calling : GOGCalling
    {
        ...
        public override void SetDefaults() {
            ...
            Item.shoot = ModContent.ProjectileType<Corrupt2DT>();
            Item.shootSpeed = 5f;
        ...
        public override bool CanUseItem(Player player) {
            ...
            if (player.altFunctionUse == 2) {
                ...
                for (int i = 0; i < Main.maxProjectiles; i++) {
                    ...
                    if (proj.type == ModContent.ProjectileType<Corrupt2DT>() && proj.owner == player.whoAmI) {
                        proj.Kill();
                    }
                }
            }
        ...
        public override void AddRecipes() {
            ...
            recipe.AddIngredient(ModContent.ItemType<CorruptCalling>(), 1);
