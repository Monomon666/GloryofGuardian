...
namespace GloryofGuardian.Content.Items.Weapons.Calling {
    public class Corrupt2 : GOGCalling {
        public override string Texture => GOGConstant.Weapons + Name;

        protected override int ProjType => ModContent.ProjectileType<Corrupt2DT>();
        ...
        public override void AddRecipes() {
            ...
            recipe.AddIngredient(ModContent.ItemType<Corrupt>(), 1);
