...
{
    public class CorruptCalling : GOGCalling
    {
        ...
        public override void SetDefaults() {
            ...
            Item.shoot = ModContent.ProjectileType<CorruptDT>();
            Item.shootSpeed = 5f;
        ...
        public override bool CanUseItem(Player player) {
            ...
            if (player.altFunctionUse == 2) {
                ...
                for (int i = 0; i < Main.maxProjectiles; i++) {
                    ...
                    if (proj.type == ModContent.ProjectileType<CorruptDT>() && proj.owner == player.whoAmI) {
                        proj.Kill();
                    }
                }
            }
