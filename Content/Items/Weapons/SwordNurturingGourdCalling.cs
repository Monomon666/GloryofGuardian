...
{
    public class SwordNurturingGourdCalling : GOGCalling
    {
        ...
        public override void SetDefaults() {
            ...
            Item.shoot = ModContent.ProjectileType<SwordNurturingGourdDT>();
            Item.shootSpeed = 5f;
        ...
        public override bool CanUseItem(Player player) {
            if (player.altFunctionUse == 0) {
                for (int i = 0; i < Main.maxProjectiles; i++) {
                    ...
                    if (proj.type == ModContent.ProjectileType<SwordNurturingGourdDT>() && proj.owner == player.whoAmI) {
                        proj.Kill();
                    }
                }
