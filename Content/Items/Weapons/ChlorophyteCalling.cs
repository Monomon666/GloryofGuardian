...
{
    public class ChlorophyteCalling : GOGCalling
    {
        ...
        public override void SetDefaults() {
            ...
            Item.shoot = ModContent.ProjectileType<ChlorophyteDT>();
            Item.shootSpeed = 5f;
        ...
        public override bool CanUseItem(Player player) {
            ...
            if (player.altFunctionUse == 2) {
                ...
                for (int i = 0; i < Main.maxProjectiles; i++) {
                    ...
                    if (proj.type == ModContent.ProjectileType<ChlorophyteDT>() && proj.owner == player.whoAmI) {
                        proj.Kill();
                    }
                }
            }
        ...
        public override void AddRecipes() {
            ...
            recipe.AddIngredient(ModContent.ItemType<MushRoomCalling>(), 1);
