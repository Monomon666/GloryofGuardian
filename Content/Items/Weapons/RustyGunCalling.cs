...
{
    public class RustyGunCalling : GOGCalling
    {
        ...
        public override void SetDefaults() {
            ...
            Item.shoot = ModContent.ProjectileType<RustyGunDT>();
            Item.shootSpeed = 5f;
        ...
        public override bool CanUseItem(Player player) {
            ...
            if (player.altFunctionUse == 2) {
                ...
                for (int i = 0; i < Main.maxProjectiles; i++) {
                    ...
                    if (proj.type == ModContent.ProjectileType<RustyGunDT>() && proj.owner == player.whoAmI) {
                        proj.Kill();
                    }
                }
            }
        ...
        public override void AddRecipes() {
            ...
            recipe.AddRecipeGroup("GloryofGuardian.AnyDungeonFactionFlags", 1);
